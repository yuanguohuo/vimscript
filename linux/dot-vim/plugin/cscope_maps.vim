...
if has("cscope")
    ...
    " add by yuanguo: Use the cscope I installed instead of the default one on mac os
    ...
    if filereadable("cscope.out")
        cs add cscope.out  
    "yuanguo: I renamed the file to .cscope.out, see rebuild_workspace.sh 
    ...
    " the new window.
    "
    " yuanguo: since 'CTRL-spacebar' will switch the languages (English/Chinese)
    " of the editor, I change it to 'CRTL-_'.
    "
